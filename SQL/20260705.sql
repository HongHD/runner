...
INSERT INTO `admins` (`id`, `name`, `email`, `password`, `created_at`, `pin_code`) VALUES
	...
	(10, '홍희대', 'hhd77@hanmail.net', '$2b$10$.RoWjDszusOHAByM2D3q9uTlaeOZDExlBbgiGCakKm6hMPSwHHdWa', '2026-06-10 14:31:24', '616332');
...
-- 테이블 데이터 ver1-1.games:~5 rows (대략적) 내보내기
DELETE FROM `games`;
...
INSERT INTO `games` (`id`, `admin_id`, `title`, `description`, `game_type`, `pin_code`, `status`, `created_at`, `settings`) VALUES
	...
	(33, 10, '실시간 설문', NULL, 'survey', NULL, 'active', '2026-06-17 07:04:41', NULL);
...
-- 테이블 데이터 ver1-1.game_sessions:~18 rows (대략적) 내보내기
...
-- 테이블 데이터 ver1-1.notes:~1 rows (대략적) 내보내기
DELETE FROM `notes`;
...
-- 테이블 데이터 ver1-1.options:~0 rows (대략적) 내보내기
DELETE FROM `options`;
...
-- 테이블 데이터 ver1-1.participants:~6 rows (대략적) 내보내기
...
-- 테이블 데이터 ver1-1.questions:~0 rows (대략적) 내보내기
